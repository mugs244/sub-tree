...
import { verifyOnboardingEmail, OnboardingError } from "@/lib/services/advertiser-onboarding"
...
export async function POST(req: Request): Promise<NextResponse> {
  ...
  try {
    const result = await verifyOnboardingEmail(session.userId, advertiser.id, code)
